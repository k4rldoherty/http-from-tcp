...
func TestGoodGetRequest(t *testing.T) {
	reader := &chunkReader{
...
func TestGoodPostRequest(t *testing.T) {
	reader := &chunkReader{
...
func TestInvalidNumberOfParts(t *testing.T) {
	_, err := RequestFromReader(
		strings.NewReader("/coffee HTTP/1.1\r\nHost: localhost:42069\r\nUser-Agent: curl/7.81.0\r\nAccept: */*\r\n\r\n"),
	)
	require.Error(t, err)
}
...
func TestZeroContentLengthNoBody(t *testing.T) {
	reader := &chunkReader{
		data: "POST /submit HTTP/1.1\r\n" +
			"Host: localhost:42069\r\n" +
			"Content-Length: 0\r\n" +
...
func TestNoContentLengthButBody(t *testing.T) {
	reader := &chunkReader{
		data: "POST /submit HTTP/1.1\r\n" +
			"Host: localhost:42069\r\n" +
			"Content-Length: 0\r\n" +
